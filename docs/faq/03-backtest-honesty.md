...
- High trade count x small edge => slippage can erase the whole strategy.
...
Standard error of an average shrinks with sqrtn. Rough practitioner floor: **>= ~30 trades** before you talk about "a result"; more is better.
...
- Haircut wins / inflate losses by sqrtn-style adjustments (PROM-style thinking).
